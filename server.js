  ...
  <div class="editor-wrap">
    <div class="editor-toolbar">
      <div class="etool-group">
        ...
        <button class="etool-btn"        id="etool-select" onclick="setDrawTool(\'select\')" title="Select &amp; Move"><svg viewBox="0 0 16 20" width="14" height="17" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round" stroke-linecap="round"><path d="M3 1l0 15 3-3 2 4 2-1-2-4 4 0z"/></svg></button>
        <button class="etool-btn"        id="etool-eraser" onclick="setDrawTool(\'eraser\')" title="Eraser"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 20H7L3 16 13 6l7 7-2.5 2.5"/><path d="M6 11l7 7"/></svg></button>
        <button class="etool-btn"        id="etool-fill"   onclick="setDrawTool(\'fill\')"   title="Paint Bucket"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 8h14l-2 13H7z"/><line x1="3" y1="8" x2="21" y2="8"/><path d="M9 8V5a3 3 0 0 0 6 0v3"/><circle cx="19" cy="22" r="1.5" fill="currentColor" stroke="none"/></svg></button>
      </div>
      <div class="etool-group">
