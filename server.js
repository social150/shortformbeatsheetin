  ...
  <div class="editor-wrap">
    <div class="editor-toolbar">
      <div class="etool-group">
        ...
        <button class="etool-btn"        id="etool-select" onclick="setDrawTool(\'select\')" title="Select &amp; Move"><svg viewBox="0 0 24 24" width="13" height="13" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M5 3l14 9-7.5 2-2 7.5z"/></svg></button>
        <button class="etool-btn"        id="etool-eraser" onclick="setDrawTool(\'eraser\')" title="Eraser"><svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="M20 20H7L3 16 13 6l7 7-2.5 2.5"/><path d="M6 11l7 7"/></svg></button>
        <button class="etool-btn"        id="etool-fill"   onclick="setDrawTool(\'fill\')"   title="Paint Bucket"><svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="M19 11L8.93 1 2 7.93 12.07 18 19 11z"/><path d="M18 12l-6 6"/><circle cx="21" cy="19" r="2" fill="currentColor" stroke="none"/></svg></button>
      </div>
      <div class="etool-group">
...
function setDrawTool(tool) {
  ...
  fabricCanvas.defaultCursor = tool === 'select' ? 'default' : tool === 'fill' ? 'cell' : 'crosshair';
  if (tool === 'select') {
...
function initEditor(imgDataUrl, pageId, vi) {
  ...
  fabricCanvas.on('mouse:down', function(opt) {
    ...
    if (drawTool === 'fill') {
      ...
      else if (!t) { fabricCanvas.backgroundColor = fc; }
